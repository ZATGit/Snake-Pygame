...
if is_pygame_pkg:
    ...
    from snowman_pygame.test import test_utils
    from snowman_pygame.test import example_path
    try:
        from snowman_pygame.test import *
    except (ImportError, NameError):
        pass
import pygame
...
class SurfaceGetBufferTest (unittest.TestCase):
    ...
    if pygame.HAVE_NEWBUF:
        ...
        if is_pygame_pkg:
            ...
            from snowman_pygame.test import buftools
